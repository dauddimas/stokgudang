...
<body>
	<div class="container-fluid">
		...
		<div class="tabelstok">
			<h1>Atur Stok Barang pada Inventori anda</h1><br><br>
			<table class="table table-bordered table-paginate" cellspacing="0" width="100%">
				...
				<tbody>
	    			...
	    			<tr>
                        ...
                        <td>
                            <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal_jumlah_keluar<?php echo $ID_barang;?>"><span class="glyphicon glyphicon-minus" style="margin-right: 4px;"></span>Kurangi</a>
                        </td>
	    			</tr>
	    			<?php endforeach;?>
				</tbody>
