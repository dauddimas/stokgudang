...
<body>
	<div class="container-fluid">
		...
		<div class="tabelstok">
			<h1>Ubah atau Hapus Barang pada Inventori anda</h1><br><br>
			<table class="table table-bordered table-paginate" cellspacing="0" width="100%">
				...
				<tbody>
	    			...
	    			<tr>
	    				...
	    				<td>
                            <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal_ubah_barang<?php echo $ID_barang;?>"><span class="glyphicon glyphicon-pencil" style="margin-right: 4px;"></span>Ubah</a>
                        </td>
                        <td>
                            <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal_hapus_barang<?php echo $ID_barang;?>"><span class="glyphicon glyphicon-trash" style="margin-right: 4px;"></span>Hapus</a>
                        </td>
	    			</tr>
	    			<?php endforeach;?>
				</tbody>
